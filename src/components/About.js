  ...
  return (
    <section id="about">
      <div className="about-container">
        ...
        <span className="about-subtitle">Um pouco sobre nós, confira os links das nossas redes sociais</span>
            ...
            <div className="person-info">
              ...
              <div className="icon-buttons-container">
                <a href="https://github.com/sidneiju/">
                  <img src={require("../images/icons/github.svg")} height="24" width="24" />
                </a>
                <a href="https://www.linkedin.com/in/sidneijunioranastacio/">
                  <img src={require("../images/icons/linkedin.svg")} height="24" width="24" />
                </a>
                <a href="https://www.instagram.com/sidnei_junior9/">
                  <img src={require("../images/icons/instagram.svg")} height="24" width="24" />
                </a>
              </div>
            </div>
          </div>
